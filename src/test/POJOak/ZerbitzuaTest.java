...
public class ZerbitzuaTest {
    ...
    public void testHegaldiConstructor() {
        ...
        assertEquals("Flight123", hegaldia.getHegaldiIzena());
    ...
    public void testOstatuaConstructor() {
        ...
        assertEquals("Hotel Bilbao", ostatua.getOstatuIzena());
        assertEquals("Double", ostatua.getLogela());
    ...
    public void testJardueraConstructor() {
        ...
        assertEquals("City Tour", jarduera.getJardueraIzena());
        assertEquals("Guided tour of Bilbao", jarduera.getJardueraDeskribapena());
